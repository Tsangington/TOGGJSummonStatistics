...
async function parseData (url) {
  /*
    ...
    */
  let summonData = await scrapeSummons(url)
...
async function getSummonObject (url) {
  /*
    ...
    */
  const parsedSummonData = await parseData(url)
  const summonStatistics = new statistics.SummonStatistics(parsedSummonData)
